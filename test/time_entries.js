...
let CLIENT_ID = null,
    PROJECT_ID = null,
    TASK_ID = null,
    PROJECT_TASK_ASSIGNMENTS_ID = null,
    TIME_ENTRY_ID = null;
...
describe('Time Entries API', function() {
    ...
    describe('Create a time entry', function() {
        ...
        it('should Create a time entry', async() => {
             ...
             */
            const theProjectTaskAssignments = await harvest.projectTaskAssignments.create(PROJECT_ID, {
                task_id: TASK_ID
            });
    ...
    describe('Delete a time entry', function() {
        ...
        it('should Delete a time entry', async() => {
            assert(TIME_ENTRY_ID);
            await harvest.timeEntries.delete(TIME_ENTRY_ID);
            await harvest.projectTaskAssignments.delete(PROJECT_ID, PROJECT_TASK_ASSIGNMENTS_ID);
        });
    });
});